...
export const EVENT_ICONS = {
    ...
    trade: `<svg xmlns="http://www.w3.org/2000/svg" width="14.595" height="13.48" viewBox="0 0 14.595 13.48"><g id="Icon_ionic-ios-cart" data-name="Icon ionic-ios-cart" transform="translate(-3.382 -4.493)"><path id="Path_47" data-name="Path 47" d="M11.247,28.967a.842.842,0,1,1-.842-.842.842.842,0,0,1,.842.842Z" transform="translate(-3.096 -11.836)"/><path id="Path_48" data-name="Path 48" d="M27.032,28.967a.842.842,0,1,1-.842-.842.842.842,0,0,1,.842.842Z" transform="translate(-11.002 -11.836)"/><path id="Path_49" data-name="Path 49" d="M17.971,6.89a.206.206,0,0,0-.182-.147L6.358,5.637a.352.352,0,0,1-.263-.165,3.574,3.574,0,0,0-.428-.653c-.27-.33-.779-.319-1.713-.326a.511.511,0,0,0-.572.495.5.5,0,0,0,.547.495,4.663,4.663,0,0,1,.912.067c.165.049.3.319.347.555a.013.013,0,0,0,0,.011c.007.042.07.358.07.361l1.4,7.426a2.729,2.729,0,0,0,.509,1.253,1.4,1.4,0,0,0,1.155.569h8.3a.5.5,0,0,0,.505-.47.489.489,0,0,0-.491-.512H8.324a.408.408,0,0,1-.291-.1,1.575,1.575,0,0,1-.4-.912L7.478,12.9a.019.019,0,0,1,.014-.021l9.746-1.65a.205.205,0,0,0,.172-.182l.562-4.064A.2.2,0,0,0,17.971,6.89Z" transform="translate(0 0)"/></g></svg>`
}
